...
/* ------------------------------------------------------------------ *
 * LinkedIn icon — this version of lucide-react dropped brand icons,
 * so we ship a matching line-style icon with the same (size, strokeWidth)
 * API the other channel icons use.
 * ------------------------------------------------------------------ */
